...
export default function MembersPage() {
  ...
  const getRoleBadge = (role: string) => {
    const styles: Record<string, { bg: string; text: string; label: string }> = {
      OWNER: { bg: "from-yellow-500 to-orange-500", text: "text-white", label: "Eigenaar" },
      ADMIN: { bg: "from-purple-500 to-pink-500", text: "text-white", label: "Beheerder" },
      EDITOR: { bg: "from-blue-500 to-cyan-500", text: "text-white", label: "Bewerker" },
      VIEWER: { bg: "from-slate-500 to-slate-600", text: "text-white", label: "Kijker" },
    };
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="mt-1 text-slate-400">
            Beheer wie toegang heeft tot deze workspace
          </p>
        </div>
        <button
      ...
      <div className="glass-card p-6">
        <h2 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
          <span>👥</span> Leden ({members.length})
        </h2>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="font-medium text-white">
                    {member.user.name || member.user.email?.split("@")[0] || "Onbekend"}
                  </div>
      ...
      {invites.length > 0 && (
        <div className="glass-card p-6">
          <h2 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            <span>✉️</span> Openstaande Uitnodigingen ({invites.length})
          </h2>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-slate-400">
                      Uitgenodigd door {invite.invitedBy.name || invite.invitedBy.email}
                    </div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
      ...
      {/* Role Legend */}
      <div className="glass-card p-6">
        <h2 className="text-lg font-semibold text-white mb-4">Rollen Uitleg</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="p-4 rounded-xl bg-white/5">
            ...
            <p className="text-xs text-slate-400">
              Volledige controle, kan workspace verwijderen en eigenaarschap overdragen
            </p>
          </div>
          <div className="p-4 rounded-xl bg-white/5">
            <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-xs text-slate-400">
              Kan leden beheren, instellingen wijzigen en live sessies starten
            </p>
          </div>
          <div className="p-4 rounded-xl bg-white/5">
            <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-xs text-slate-400">
              Kan vragen, quizzen en media maken en bewerken
            </p>
          </div>
          <div className="p-4 rounded-xl bg-white/5">
            <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-xs text-slate-400">
              Kan alleen content bekijken, geen wijzigingen maken
            </p>
          </div>
        </div>
      </div>
...
function InviteModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        setError(data.error || "Kon uitnodiging niet versturen");
        return;
      }
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="glass-elevated max-w-md w-full p-6 animate-fade-in">
        {!success ? (
          <>
            <div className="mb-6">
              <h3 className="text-xl font-semibold text-white">Lid Uitnodigen</h3>
              <p className="text-sm text-slate-400 mt-1">
                Stuur een uitnodiging naar een teamlid
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="EDITOR">Bewerker - Kan content maken</option>
          ...
          <>
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Uitnodiging Verstuurd!</h3>
              <p className="text-slate-400 mb-6">
                We hebben een uitnodiging gestuurd naar <span className="text-white">{email}</span>
              </p>
            </div>
