    ...
    <div className="flex-1 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <h1 className="text-6xl font-black text-white mb-2">🎉 PartyQuiz</h1>
          <p className="text-xl text-white/90">Join the fun!</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="ABC123"
                className="w-full px-6 py-4 text-3xl font-bold text-center tracking-widest border-4 border-gray-300 rounded-xl focus:border-purple-500 focus:ring-4 focus:ring-purple-200 outline-none transition-all uppercase"
                maxLength={6}
                autoComplete="off"
                autoFocus
              />
